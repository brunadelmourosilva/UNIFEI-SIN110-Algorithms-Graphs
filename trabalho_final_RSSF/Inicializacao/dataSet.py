...
def criaMatrizAdjacencias(instancia):
    ...
    caminho = '/home/bdelmouro/IdeaProjects/My Projects/UNIFEI/UNIFEI-SIN110-Algorithms-Graphs/trabalho_final_RSSF/Instancias/' + instancia + '.txt'
...
def salvaResultado(resultado, funcao):
    ...
    for res in resultado:
        stringRes += str(res) + ' '
    arquivo = open('/home/bdelmouro/IdeaProjects/My Projects/UNIFEI/UNIFEI-SIN110-Algorithms-Graphs/trabalho_final_RSSF/Resultados/Arquivos/{}.txt'.format(funcao), 'a+')
